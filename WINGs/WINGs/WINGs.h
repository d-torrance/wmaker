...
WTexSolid *wTextureMakeSolid(WMScreen*, XColor*);
WTexGradient *wTextureMakeGradient(WMScreen*, int, const RColor*, const RColor*);
WTexMGradient *wTextureMakeMGradient(WMScreen*, int, RColor**);
WTexTGradient *wTextureMakeTGradient(WMScreen*, int, const RColor*, const RColor*, const char *, int);
WTexIGradient *wTextureMakeIGradient(WMScreen*, int, const RColor[], int, const RColor[]);
WTexPixmap *wTextureMakePixmap(WMScreen *scr, int style, const char *pixmap_file,
                               XColor *color);
void wTextureDestroy(WMScreen*, WTexture*);
